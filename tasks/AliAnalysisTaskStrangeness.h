...
#ifndef AliAnalysisTaskStrangeness_H
#define AliAnalysisTaskStrangeness_H
...
class AliAnalysisTaskStrangeness : public AliAnalysisTaskSE {
public:
    AliAnalysisTaskStrangeness();
    AliAnalysisTaskStrangeness(Bool_t lSaveEventTree, Bool_t lSaveV0Tree, Bool_t lSaveCascadeTree, const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskStrangeness();
...
//===========================================================================================
    ...
    AliAnalysisTaskStrangeness(const AliAnalysisTaskStrangeness&);            // not implemented
    AliAnalysisTaskStrangeness& operator=(const AliAnalysisTaskStrangeness&); // not implemented

    ClassDef(AliAnalysisTaskStrangeness, 4);
