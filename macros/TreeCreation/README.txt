...
2) Run the macro runMode.C changing the flag "full" to "terminate" in this line (at the very end):  alienHandler->SetRunMode("full");
  ...
  in aliroot              
  >> .L runMode.C   
  >> runMode(Period)  example for LHC12b  Period=122 (year (12) + b second letter of the alphabet)
