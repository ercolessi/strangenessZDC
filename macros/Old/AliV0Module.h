...
Inspired from version: 27th April 2012 
--- David Dobrigkeit Chinellato
    daviddc@ifi.unicamp.br

Private version: 11/02/2020 
--- Francesca Ercolessi
...
public: 
  ...
  void SetLowEnergyValue            ( Double_t lLoEnergyBound    );
  void SetHighEnergyValue            ( Double_t lHiEnergyBound    );
  ...
  void SetMultEstimator( TString lWhichEstimator = "fRefMultEta5" ){ fWhichEstimator = lWhichEstimator; }
...
private:
  ...
  Double_t fLoEnergyBound;
  Double_t fHiEnergyBound;
