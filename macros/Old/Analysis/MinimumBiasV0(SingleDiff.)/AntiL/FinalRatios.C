...
void FinalRatios() {
  ...
  const char *outputname = "LambdaLevyTsallis.root";
  const char *spectrafile = "AntiLPtSpectra.root";
  ...
  for (int j = 0 ; j < ctr ; j++) { 
    ...
    for (int i = 7; i <= hPT[j]->GetNbinsX(); i++){
  ...
  for(int j=0;j < (ctr-1);j++){
    ...
    normyields[j] = yields[j]*1./mult[j]; 
    enormyields[j] = eyields[j]*1./mult[j];   
    multScaled[j] = mult[j]*1./mult[ctr-1];
    emultScaled[j] = 0;
    prodScaled[j] = normyields[j]*1./normyields[ctr-1];
    eprodScaled[j] = enormyields[j]*1./normyields[ctr-1];
  ...
  hPTClone[5]->SetLineColor(kTeal+10);
  hPTClone[5]->SetMarkerColor(kTeal+10);
  hPTClone[6]->SetLineColor(kAzure+10);
  hPTClone[6]->SetMarkerColor(kAzure+10);
  hPTClone[7]->SetLineColor(kAzure-3);
  hPTClone[7]->SetMarkerColor(kAzure-3);
  hPTClone[8]->SetLineColor(kBlue+1);
  hPTClone[8]->SetMarkerColor(kBlue+1);
  hPTClone[9]->SetLineColor(kBlue+3);
  hPTClone[9]->SetMarkerColor(kBlue+3);
  hPTClone[10]->SetLineColor(kBlack);
  hPTClone[10]->SetMarkerColor(kBlack);
  ...
  ffit[5]->SetLineColor(kTeal+10);
  ffit[5]->SetLineStyle(9);
  ffit[6]->SetLineColor(kAzure+10);
  ffit[6]->SetLineStyle(9);
  ffit[7]->SetLineColor(kAzure-3);
  ffit[7]->SetLineStyle(9);
  ffit[8]->SetLineColor(kBlue+1);
  ffit[8]->SetLineStyle(9);
  ffit[9]->SetLineColor(kBlue+3);
  ffit[9]->SetLineStyle(9);
  ffit[10]->SetLineColor(kBlack);
  ffit[10]->SetLineStyle(9);

  hPTClone[0]->SetTitle("0.0-1.0");
  hPTClone[1]->SetTitle("1.0-5.0");
  hPTClone[2]->SetTitle("5.0-10.0");
  hPTClone[3]->SetTitle("10.0-15.0");
  hPTClone[4]->SetTitle("15.0-20.0");
  hPTClone[5]->SetTitle("20.0-30.0");
  hPTClone[6]->SetTitle("30.0-40.0");
  hPTClone[7]->SetTitle("40.0-50.0");
  hPTClone[8]->SetTitle("50.0-70.0");
  hPTClone[9]->SetTitle("70.0-100.0");
  hPTClone[10]->SetTitle("0.0-100.0");
  hPTClone[10]->SetMarkerStyle(25);

   hPTClone[0]->Scale(1/0.639);
  double par0 = ffit[0]->GetParameter(3);
  ffit[0]->SetParameter(3, par0/0.639);
  hPTClone[1]->Scale(1/0.639);
  double par1 = ffit[1]->GetParameter(3);
  ffit[1]->SetParameter(3, par1/0.639);
  hPTClone[2]->Scale(1/0.639);
  double par2 = ffit[2]->GetParameter(3);
  ffit[2]->SetParameter(3, par2*1/0.639);
  hPTClone[3]->Scale(1./0.639);
  double par3 = ffit[3]->GetParameter(3);
  ffit[3]->SetParameter(3, par3/0.639);
  hPTClone[4]->Scale(1./0.639);
  double par4 = ffit[4]->GetParameter(3);
  ffit[4]->SetParameter(3, par4/0.639);
  hPTClone[5]->Scale(1./0.639);
  double par5 = ffit[5]->GetParameter(3);
  ffit[5]->SetParameter(3, par5/0.639);
  hPTClone[6]->Scale(1./0.639);
  double par6 = ffit[6]->GetParameter(3);
  ffit[6]->SetParameter(3, par6/0.639);
  hPTClone[7]->Scale(1/0.639);
  double par7 = ffit[7]->GetParameter(3);
  ffit[7]->SetParameter(3, par7/0.639);
  hPTClone[8]->Scale(1/0.639);
  double par8 = ffit[8]->GetParameter(3);
  ffit[8]->SetParameter(3, par8/0.639);
  hPTClone[9]->Scale(1/0.639);
  double par9 = ffit[9]->GetParameter(3);
  ffit[9]->SetParameter(3, par9/0.639);
  ...
  hPTClone[0]->SetAxisRange(1E-6,1.,"Y");
  hPTClone[0]->Draw();
  ffit[0]->Draw("SAME");
