...
void StrangeModeROOT6(Int_t Period)
...
gROOT->ProcessLine(".include $ROOTSYS/include");
  ...
  //gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/FORWARD/analysis2/AddTaskForwardMult.C++g");
  AliAnalysisTask* fw =  reinterpret_cast<AliAnalysisTask*>(gInterpreter->ExecuteMacro("$ALICE_PHYSICS/PWGLF/FORWARD/analysis2/AddTaskForwardMult.C\(0.\)"));

  //PhysicsSelection Configuration
  //gROOT->LoadMacro("$ALICE_PHYSICS/OADB/macros/AddTaskPhysicsSelection.C");
  AliPhysicsSelectionTask* ps =  reinterpret_cast<AliPhysicsSelectionTask*>(gInterpreter->ExecuteMacro("$ALICE_PHYSICS/OADB/macros/AddTaskPhysicsSelection.C\(kFALSE, kTRUE\)"));
  //Signature: Bool_t mCAnalysisFlag, Bool_t applyPileupCuts
  
  //MultSelection
  // gROOT->LoadMacro("$ALICE_PHYSICS/OADB/COMMON/MULTIPLICITY/macros/AddTaskMultSelection.C");
  AliMultSelectionTask* ms =  reinterpret_cast<AliMultSelectionTask*>(gInterpreter->ExecuteMacro("$ALICE_PHYSICS/OADB/COMMON/MULTIPLICITY/macros/AddTaskMultSelection.C\(kFALSE\)"));
  ...
  if(Period==1561) ms->SetAlternateOADBFullManualBypass(
    //"../PPCalibration/OADB-15f-test2.root");
							"alien:///alice/cern.ch/user/f/fercoles/DataFiles/OADB-LHC15f-pt1MB.root");
  ...
  //Strangness Task
  gROOT->LoadMacro("AliAnalysisTaskStrangenessVsMultiplicityEERun2.cxx++g");
  //gROOT->LoadMacro("AddTaskStrangenessVsMultiplicityEERun2.C"); $ALICE_PHYSICS/PWGLF/STRANGENESS/Cascades/Run2/macros/A
  ...
  if (grid)
    {
      ...
      alienHandler->SetAliPhysicsVersion("vAN-20200317_ROOT6-1");   
      ...
      alienHandler->SetAdditionalLibs("$ALICE_PHYSICS/PWGLF/STRANGENESS/Cascades/Run2/AliAnalysisTaskStrangenessVsMultiplicityEERun2.cxx $ALICE_PHYSICS/PWGLF/STRANGENESS/Cascades/Run2/AliAnalysisTaskStrangenessVsMultiplicityEERun2.h");
      alienHandler->SetAnalysisSource("$ALICE_PHYSICS/PWGLF/STRANGENESS/Cascades/Run2/AliAnalysisTaskStrangenessVsMultiplicityEERun2.cxx ");
	...
	alienHandler->SetDataPattern("/pass2/*/AliESDs.root");
	// runnumber
	Int_t runList[24] = {225016,225322,225031,225310,225106,225315,225307,225314,225041,225016,225037,225050,225043,225105,225026,225035,225305,225052,225313,225051,225309,225576,225587,225582};
	for (Int_t i= 1;i <2; i++) alienHandler->AddRunNumber(runList[i]);
	
	alienHandler->SetGridWorkingDir("AnalysisLeading2019/Strangeness/15fpass2/Test");
      }
	...
	alienHandler->SetGridWorkingDir("AnalysisLeading2019/Strangeness/15fpass2pt3/");
      }
